...
async function inspectPage(page, slug) {
  ...
  const productCount = await page.evaluate(() => document.querySelectorAll('.product-item, .bestsellerslider-item, .newproduct-item, .mostviewedproduct-item, .onsaleproduct-item, .owl-item:not(.cloned)').length);
