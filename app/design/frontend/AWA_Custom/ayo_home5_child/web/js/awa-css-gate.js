...
(function () {
    ...
    var QUEUE_HEADER_FIRST_FRAGMENTS = [
        ...
        'awa-vertical-menu-stack-2026-05-28',
    ...
    /** Header refine terminal — injeta SOMENTE após fila gate terminar de carregar. */
    function injectHeaderRefineTerminal() {
        return new Promise(function (resolve) {
            var queueNode = document.getElementById('awa-css-gate-queue');
            var href = queueNode ? queueNode.getAttribute('data-awa-terminal-href') : '';
            href = normalizeTerminalHref(href);
            var probe;
            var link;

            if (document.querySelector('link[href*="awa-header-refine-terminal"]')) {
                resolve();
                return;
            }

            if (!href) {
                probe = document.querySelector(
                    'link[href*="awa-home-hover-lock"], ' +
                    'link[href*="awa-bundle-refinements"], ' +
                    'link[href*="awa-ui-simplify-terminal"], ' +
                    'link[href*="/static/"][href*="/css/"]'
                );
                ...
                href = normalizeTerminalHref(
                    probe.href.replace(/[^/]+$/, 'awa-header-refine-terminal.min.css')
                );
            }
            ...
            link.rel = 'stylesheet';
            link.href = href;
            link.setAttribute('data-awa-header-refine-terminal', '1');
            link.onload = resolve;
    ...
    function injectImpeccableRefineTerminal() {
        return new Promise(function (resolve) {
            ...
            href = '';
            if (probe && probe.href) {
                href = probe.href.split('?')[0] + '?v=20260605-fix16';
            } else {
    ...
    function injectPostGateHeaderFix() {
        ...
        if (document.getElementById('awa-header-impeccable-cascade-lock-v14')) {
            return;
        }
