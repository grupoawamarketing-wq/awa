!function(e,t){"use strict";if(!e.__awaQaAccessibilitySafeInit){e.__awaQaAccessibilitySafeInit=!0;let a=0,r=!1,n=null,o=null,i=!1;"loading"!==t.readyState?E():t.addEventListener("DOMContentLoaded",E,{once:!0})}function u(e){return String(e||"").replace(/\s+/g," ").trim()}function s(e,t){return e?(e.id||(a+=1,e.id=(t||"awa-node")+"-"+a),e.id):""}function c(e,t){let a=u(t);e&&a&&(e.getAttribute("aria-label")||e.setAttribute("aria-label",a),!e.getAttribute("title")&&e.matches("a, button, input, select, textarea")&&e.setAttribute("title",a))}function l(e,t){let a,r;if(!e)return null;for(a=e.children||[],r=0;r<a.length;r+=1)if(a[r].matches&&a[r].matches(t))return a[r];return null}function q(e){return e&&e.labels&&e.labels.length?u(Array.prototype.map.call(e.labels,function(e){return e.textContent||""}).join(" ")):""}function C(e){let a,r,n;if(!e)return"";if((a=e.closest("label"))&&u(a.textContent))return u(a.textContent);if((r=e.previousElementSibling)&&r.matches("label")&&u(r.textContent))return u(r.textContent);if((n=e.nextElementSibling)&&n.matches("label")&&u(n.textContent))return u(n.textContent);return""}function L(e){let a,r,n,o;if(!e||e.getAttribute("aria-label")||e.getAttribute("aria-labelledby")||!p(e))return;a=q(e),a||(r=e.id,r&&(n=t.querySelector('label[for="'+r.replace(/"/g,'\\"')+'"]'),a=n?u(n.textContent):"")),a||(a=C(e)),a||(o=e.getAttribute("placeholder")||e.getAttribute("title")||"select"===e.tagName.toLowerCase()&&e.name?e.name:""),c(e,a)}function x(){Array.prototype.slice.call(t.querySelectorAll("#mst_categorySearch")).forEach(function(e){c(e,e.getAttribute("placeholder")||"Buscar produtos nesta categoria")}),Array.prototype.slice.call(t.querySelectorAll("#sorter, .sorter-options")).forEach(function(e){c(e,"Ordenar produtos por")}),Array.prototype.slice.call(t.querySelectorAll("#limiter, .limiter-options")).forEach(function(e){c(e,"Produtos por página")}),Array.prototype.slice.call(t.querySelectorAll('#choose_category, select[name="cat"]')).forEach(function(e){c(e,"Categoria")}),Array.prototype.slice.call(t.querySelectorAll('input:not([type="hidden"]):not([aria-label]):not([aria-labelledby]), select:not([aria-label]):not([aria-labelledby]), textarea:not([aria-label]):not([aria-labelledby])')).forEach(L)}function d(){i||(i=!0,e.requestAnimationFrame(function(){let e;i=!1,Array.prototype.slice.call(t.querySelectorAll('.block-search, [data-awa-component="search-autocomplete"]')).forEach(y),x(),e=t.querySelectorAll(".navigation.custommenu.main-nav, .navigation.verticalmenu.side-verticalmenu"),Array.prototype.slice.call(e).forEach(function(e){let t=e.querySelector('[data-role="awa-vertical-menu-trigger"]');t&&t.setAttribute("aria-haspopup","true"),Array.prototype.slice.call(e.querySelectorAll("li")).forEach(function(e){let t,a=l(e,"a"),r=l(e,".open-children-toggle"),n=l(e,".submenu, .groupmenu, .subchildmenu, ul.level0"),o=u(a?a.textContent:e.textContent)||"Submenu";n?(t=e.classList.contains("active")||e.classList.contains("_active")||n.classList.contains("opened")||n.classList.contains("active")||n.classList.contains("is-open")||p(n),s(n,"awa-menu-panel"),n.setAttribute("aria-hidden",t?"false":"true"),a&&(a.setAttribute("aria-haspopup","true"),c(a,o)),r&&(r.setAttribute("role","button"),r.setAttribute("tabindex",r.getAttribute("tabindex")||"0"),r.setAttribute("aria-controls",n.id),r.setAttribute("aria-expanded",t?"true":"false"),c(r,(t?"Recolher ":"Expandir ")+o))):a&&c(a,o)})})}))}function p(e){return!(!e||e.hidden||"true"===e.getAttribute("aria-hidden"))&&null!==e.offsetParent}function f(e){return e?Array.prototype.slice.call(e.querySelectorAll(["a[href]","button:not([disabled])","textarea:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","))).filter(p):[]}function b(){let e=t.getElementById("maincontent");return e&&!e.hasAttribute("tabindex")&&e.setAttribute("tabindex","-1"),e}function h(e){let a,r,n,o=e.querySelector('[data-awa-search-input="true"], #search, input[name="q"]'),i=e.querySelector('[data-awa-search-help], #awa-search-help');return o?(i&&i.setAttribute("data-awa-search-help","true"),i||((i=t.createElement("span")).className="awa-sr-only",i.setAttribute("data-awa-search-help","true"),i.textContent="Digite ao menos 2 caracteres para ver sugestões e use as setas para navegar.",e.appendChild(i)),s(i,"awa-search-help"),a=o,r=i.id,a&&r&&-1===(n=(a.getAttribute("aria-describedby")||"").split(/\s+/).filter(Boolean)).indexOf(r)&&(n.push(r),a.setAttribute("aria-describedby",n.join(" "))),i):null}function y(e){let t,a,r,n,o;e&&(t=e.querySelector('[data-awa-search-input="true"], #search, input[name="q"]'),a=e.querySelector('[data-awa-search-category-select="true"], #choose_category'),r=e.querySelector('#search_autocomplete, [data-awa-search-panel="true"]'),n=e.querySelector('#searchsuite-autocomplete, [data-awa-search-results-root="true"], .searchsuite-autocomplete'),h(e),t&&c(t,t.getAttribute("placeholder")||"Buscar produtos"),a&&c(a,"Categoria"),r&&(s(r,"awa-search-panel"),r.setAttribute("role",r.getAttribute("role")||"listbox"),r.setAttribute("aria-label",r.getAttribute("aria-label")||"Sugestões de busca"),t&&!t.getAttribute("aria-controls")&&t.setAttribute("aria-controls",r.id)),n&&(n.setAttribute("aria-label",n.getAttribute("aria-label")||"Resultados da busca em tempo real"),Array.prototype.slice.call(n.querySelectorAll("a[href], button")).forEach(function(e){let t=e.getAttribute("data-awa-option-label")||e.getAttribute("aria-label")||u(e.textContent);c(e,t)})),o=e.querySelectorAll('.search-autocomplete li, .searchsuite-autocomplete li, [role="option"]'),Array.prototype.slice.call(o).forEach(function(e){e.setAttribute("role","option"),e.setAttribute("aria-selected",e.getAttribute("aria-selected")||"false"),e.setAttribute("tabindex",e.getAttribute("tabindex")||"-1"),s(e,"awa-search-option")}))}function v(){return t.getElementById("awa-quote-modal")}function A(e){Array.prototype.slice.call(t.querySelectorAll("[data-awa-quote-open]")).forEach(function(t){t.setAttribute("aria-expanded",e?"true":"false")})}function m(){let e=v();e&&(e.classList.remove("is-open"),e.setAttribute("aria-hidden","true"),t.body.classList.remove("awa-modal-open"),A(!1),r&&(t.removeEventListener("keydown",g,!0),r=!1),n&&"function"==typeof n.focus&&n.focus())}function g(e){let a=v();if(a&&"true"!==a.getAttribute("aria-hidden"))return"Escape"===e.key?(e.preventDefault(),void m()):void("Tab"===e.key&&function(e,a){let r,n,o=f(a);o.length?(r=o[0],n=o[o.length-1],e.shiftKey&&t.activeElement===r?(e.preventDefault(),n.focus()):e.shiftKey||t.activeElement!==n||(e.preventDefault(),r.focus())):(e.preventDefault(),a.focus())}(e,a))}function w(){let a=v();Array.prototype.slice.call(t.querySelectorAll("[data-awa-quote-open]")).forEach(function(a){"true"!==a.dataset.awaQuoteOpenBound&&(a.addEventListener("click",function(){!function(a){let o,i,u=v();u&&(n=a||t.activeElement,u.classList.add("is-open"),u.setAttribute("aria-hidden","false"),t.body.classList.add("awa-modal-open"),A(!0),o=u.querySelector("[data-awa-quote-autofocus]"),i=f(u),e.setTimeout(function(){o&&"function"==typeof o.focus?o.focus():i.length&&"function"==typeof i[0].focus?i[0].focus():u.focus()},0),r||(t.addEventListener("keydown",g,!0),r=!0))}(a)}),a.dataset.awaQuoteOpenBound="true")}),a&&"true"!==a.dataset.awaQuoteModalBound&&(a.addEventListener("click",function(e){let t=e.target;t&&t.closest("[data-awa-quote-close]")&&m()}),a.dataset.awaQuoteModalBound="true")}function E(){let a;b(),Array.prototype.slice.call(t.querySelectorAll(".awa-skip-link, .vmm-skip-nav")).forEach(function(t){"true"!==t.dataset.awaSkipBound&&(t.addEventListener("click",function(){let t=b();t&&e.setTimeout(function(){t.focus({preventScroll:!1})},0)}),t.dataset.awaSkipBound="true")}),function(){let a=t.getElementById("awa-back-to-top");function r(){let r=(e.pageYOffset||t.documentElement.scrollTop||0)>600;a.hidden=!r,a.classList.toggle("is-visible",r),a.setAttribute("aria-hidden",r?"false":"true")}a&&"true"!==a.dataset.awaBackToTopBound&&(a.addEventListener("click",function(){e.scrollTo({top:0,behavior:"function"==typeof e.matchMedia&&e.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})}),e.addEventListener("scroll",r,{passive:!0}),r(),a.dataset.awaBackToTopBound="true")}(),w(),a=t.querySelectorAll('.block-search, [data-awa-component="search-autocomplete"]'),Array.prototype.slice.call(a).forEach(y),x(),o||"undefined"==typeof MutationObserver||(o=new MutationObserver(function(){n||(n=e.setTimeout(function(){n=null,d()},120))})).observe(t.body,{childList:!0,subtree:!0}),d(),t.addEventListener("click",function(t){t.target&&t.target.closest(".navigation, .block-search, .search-autocomplete, .searchsuite-autocomplete, .toolbar, .mst_categorySearch, #newsletter_pop_up, .modal-popup")&&e.setTimeout(d,0)},!0),e.addEventListener("resize",function(){e.requestAnimationFrame(d)},{passive:!0})}}(window,document);
...
!function(w, d) {
    ...
    function applyFixes() {
        ...
        d.querySelectorAll('.awa-footer-business-contact__action[aria-label]').forEach(function (link) {
            ...
            let visibleText = (link.innerText || link.textContent || '').replace(/\s+/g, ' ').trim().toLowerCase();
        ...
        let navToggle = d.querySelector('.action.nav-toggle[aria-label][data-action="toggle-nav"]');
        if (navToggle) {
            let visText = (navToggle.innerText || navToggle.textContent || '').replace(/\s+/g, ' ').trim();
            let curLabel = navToggle.getAttribute('aria-label') || '';
        ...
        let catTrigger = d.querySelector('.title-category-dropdown[aria-label]');
        if (catTrigger) {
            let catVisText = (catTrigger.innerText || catTrigger.textContent || '').replace(/\s+/g, ' ').trim();
            let catLabel = catTrigger.getAttribute('aria-label') || '';
        ...
        let mainEl = d.querySelector('main#maincontent');
        if (mainEl && w.getComputedStyle(mainEl).display === 'none') {
            let contentTop = d.querySelector('.content-top-home');
        ...
        let authLogo = d.querySelector('.block-authentication .wave-top img.logo');
