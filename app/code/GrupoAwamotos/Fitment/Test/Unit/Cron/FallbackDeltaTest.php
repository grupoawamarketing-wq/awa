...
use GrupoAwamotos\Fitment\Cron\FallbackDelta;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Psr\Log\LoggerInterface;

/**
 * @covers \GrupoAwamotos\Fitment\Cron\FallbackDelta
 */
class FallbackDeltaTest extends TestCase
{
    private FallbackDelta $cron;
