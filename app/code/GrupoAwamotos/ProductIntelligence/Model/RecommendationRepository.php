...
use GrupoAwamotos\ProductIntelligence\Api\RecommendationRepositoryInterface;
use GrupoAwamotos\ProductIntelligence\Api\Data\MetricsInterface;
use GrupoAwamotos\ProductIntelligence\Model\Data\Metrics;
use GrupoAwamotos\ProductIntelligence\Model\MetricasConversaoFactory;
use GrupoAwamotos\ProductIntelligence\Model\ResourceModel\CustomerClassification\CollectionFactory as CustomerClassificationCollectionFactory;
use GrupoAwamotos\ProductIntelligence\Model\ResourceModel\MetricasConversao\CollectionFactory as MetricasConversaoCollectionFactory;
use GrupoAwamotos\ProductIntelligence\Model\ResourceModel\NetworkRules\CollectionFactory as NetworkRulesCollectionFactory;
use GrupoAwamotos\ProductIntelligence\Model\ResourceModel\Recomendacao\CollectionFactory as RecomendacaoCollectionFactory;
...
class RecommendationRepository implements RecommendationRepositoryInterface
{
    ...
    public function registerConversion(string $chaveGlobal, float $valorConversao): bool
    {
        try {
            ...
            $this->logger->error('[ProductIntelligence] registerConversion failed: ' . $e->getMessage());
            return false;
        }
    }
